        ...
        <div class="flex h-16 items-center justify-between">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <?php else: ?>
                                <a href="/register"
                                   class="<?= urlIs('/register') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                                    Register
                                </a>
                                <a href="/login"
                                   class="<?= urlIs('/login') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                                    Login
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <?php if ($_SESSION['user'] ?? false): ?>
                        <div class="relative">
                            <form method="POST" action="/logout">
                                ...
                                <button type="submit"
                                        class="ml-4 rounded-md bg-gray-800 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                                    Logout
                                </button>
                            </form>
                        </div>
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button type="button" aria-controls="mobile-menu" aria-expanded="false"
                    ...
                    <svg viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" data-slot="icon"
